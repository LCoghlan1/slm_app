...
class AbsencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post absences_url, params: { absence: { date: @absence.date, description: @absence.description, employee_id: @absence.employee_id, full_pay: @absence.full_pay, half_pay: @absence.half_pay } }
    end
  ...
  test "should update absence" do
    patch absence_url(@absence), params: { absence: { date: @absence.date, description: @absence.description, employee_id: @absence.employee_id, full_pay: @absence.full_pay, half_pay: @absence.half_pay } }
